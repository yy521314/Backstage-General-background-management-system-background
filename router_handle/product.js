...
exports.createProduct = (req, res) => {
    ...
    const product_all_price =
        product_in_warehouse_number * 1 * product_single_price;
...
exports.auditProduct = (req, res) => {
    ...
    if (product_out_status == "同意") {
        ...
        const newWarehouseNumber =
            product_in_warehouse_number * 1 - product_out_number * 1;
        // 新的库存总价
        ...
        db.query(
            ...
            (err, result) => {
                ...
                db.query(
                    sql1, [newWarehouseNumber, product_all_price, req.body.id],
                    (err, result) => {
                        if (err) return res.cc(err);
                        res.send({
                            status: 0,
